...
O cadastro de Clientes feitas no Protheus é feito via **"Módulo 06 - Financeiro"**.

De forma mais técnica, as informações cadastradas no Protheus é feita pela rotina padrão **MATA090.PRW** e suas informações podem ser encontradas na tabela **"Clientes - SA1"**.

[SM2 - Clientes | ERP Labs](https://erplabs.com.br/SA1)
...
Acesso a rotina de cadastro de Clientes via Módulo Financeiro:
