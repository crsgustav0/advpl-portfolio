...
![alt text](src/COMA210.png)

Acesso a rotina de cadastro de Perfil de Aprovadores via Módulo Compras:

![alt text](<src/Acesso-Perfil de Aprovadores_Compras.png>)
...
![alt text](<src/Campos-Perfil de Aprovadores_Compras.png>)
...
## ![alt text](src/CampoLimiteMin-Perfil%20de%20Aprovadores_Compras.png)

## ![alt text](src/CampoLimiteMax-Perfil%20de%20Aprovadores_Compras.png)
