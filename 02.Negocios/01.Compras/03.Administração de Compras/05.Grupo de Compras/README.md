...
![alt text](src/COMA086.png)

Acesso a rotina de cadastro de Grupo de Compras via Módulo Compras:

![alt text](src/Acesso-GrupoCompras_Compras.png)
...
![alt text](src/Campos-Grupo de Compras_Compras.png)
...
![alt text](src/CampoUsuario-Grupo de Compras_Compras.png)

![alt text](src/CampoUsuario-GrupoCompras_Compras.png)
