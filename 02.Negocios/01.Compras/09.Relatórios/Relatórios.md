...
O cadastro de Relatórios feitas no Protheus é feito via **"Módulo 06 - Compras"**.

De forma mais técnica, as informações cadastradas no Protheus é feita pela rotina padrão **MATA110.PRW** e suas informações podem ser encontradas na tabelas **"Tabela de Relatórios - SC8"**.

[SC8 - Relatórios | ERP Labs](https://erplabs.com.br/SC8)
...
**Obs: A rotina atua com a premissa de que será feitas as Relatórios das Solicitações de Compras já cadastradas.**.

Acesso a rotina de cadastro de Relatórios via Módulo Compras:
