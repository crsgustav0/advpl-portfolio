...
![alt text](src/GerarSlcArmazem-Acesso-EstoqueCustos.png)

![alt text](src/MATA106.png)
...
![alt text](src/GerarSlcArmazem-EstoqueCustos.png)

![alt text](src/GerarSlcArmazem2-EstoqueCustos.png)
