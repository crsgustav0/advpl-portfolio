...
![alt text](src/SlcArmazem-Acesso-EstoqueCustos.png)

![alt text](src/MATA105.png)

### Cabeçalho

Os campos **"N. Solicitação"**, **"Solicitante"** e **"Data Emissão"** são preenchidos automaticamente.

![alt text](src/Cabecalho-Campo-SlcArmazem-EstoqueCustos.png)
...
![alt text](src/Produto-Campo-SlcArmazem-EstoqueCustos.png)

- **Quantidade**

Definição Quantidade produto a ser Solicitado.

![alt text](src/Quantidade-Campo-SlcArmazem-EstoqueCustos.png)

- **Data Necessidade** e **Armazem**

Definição data necessidade do Produto e Armazém a ser solicitado.

![alt text](src/DataNecessidade-Campo-SlcArmazem-EstoqueCustos.png)

- **C. Custo** e **Conta Contábil**

Campos não obrigatórios mas podem ser definidos.

![alt text](src/CCusto-Campo-SlcArmazem-EstoqueCustos.png)
