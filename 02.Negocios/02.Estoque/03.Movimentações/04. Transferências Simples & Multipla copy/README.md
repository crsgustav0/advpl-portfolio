...
![alt text](src/TrnMultipla-Acesso-EstoqueCustos.png)



![alt text](src/MATA261.png)
...
![alt text](src/Produtos-Campo-TrnMultipla-EstoqueCustos.png)

- **Quantidade**

Definição da Quantidade do Produto a ser transferido, necessário também informar o campo **"Armazém Destino"**.

![alt text](src/QtdeProduto-Campo-TrnMultipla-EstoqueCustos.png)

![alt text](src/ArmDestino-Campo-TrnMultipla-EstoqueCustos.png)

Após a inclusão é possível visualizar a legenda do registro.

![alt text](src/Legenda-Campo-TrnMultipla-EstoqueCustos.png)
