...
![alt text](src/AcessoGrupos-EstoqueCustos.png)
...
![alt text](src/CamposGrupoProdutos-EstoqueCustos.png)
...
![alt text](src/Procedencia-Campo-EstoqueCustos.png)
...
![alt text](src/StatusGrupo-Campo-EstoqueCustos.png)

- **Tipo Grupo**

Especifico para uso de concessionárias.

![alt text](src/TipoGrupo-Campo-EstoqueCustos.png)
